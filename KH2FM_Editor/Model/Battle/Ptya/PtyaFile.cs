...
namespace KH2FM_Editor.Model.Battle.Ptya
{
    public class PtyaFile : BarSubFile
    {
        ...
        //public ObservableCollection<PtyaSet> WeaponSets { get; set; } // 24
        ...
        /*public void processSets(List<byte> raw)
        {
            ...
            for (int i = 0; i < PointerSet.Count; i++)
            {
                ...
                WeaponSets.Add(new PtyaSet(PtyaPointers.getCharacter(i), raw.GetRange((int)PointerSet[i] * intSize, (int)setSize * intSize)));
            }
        ...
        public List<byte> getAsByteList()
        {
            ...
            // 24 Sets
            foreach (PtyaSet inventory in WeaponSets)
            {
